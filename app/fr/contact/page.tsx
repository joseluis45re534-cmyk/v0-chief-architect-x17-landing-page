...
export const metadata = {
    title: "Contactez-nous - Chief Architect X17",
    description:
        "Contactez l'équipe de support de Chief Architect. Nous sommes là pour vous aider avec vos besoins de conception architecturale.",
}
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 text-pretty">
                            Vous avez des questions ? Nous sommes là pour vous aider à tirer le meilleur parti de Chief Architect X17.
                        </p>
                    </div>
